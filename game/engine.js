...
const LOCATION_BANNERS = {
  title: {
    lines: [
      ...
      "*  | |    || |  _  |    | \\ || \\ | || |/  / / _ \\|  \\  *    *",
      "*  | |----|| | |_| |--- |  \\||  \\| ||   < |  __/|    \\ *    *",
      "*  | |____| \\_____|_____|_| \\_||_| \\_||_|\\_\\ \\___|\\____/*   *",
      "*       ** THE  RED  DRAGON **  -- A Classic BBS Door Game   *",
      "*============================================================*",
    ],
    colors: ['yellow','red','yellow','yellow','red','white','yellow'],
  },
  town: {
    lines: [
      "  /\\    _   _  /\\   [HAROOD]   /\\  _    _   /\\   |\\          ",
  ...
  forest: {
    lines: [
      ...
      "/|X|\\|X|\\|X|\\|X|\\  *  /|X|\\|X|\\|X|\\  *  /|X|\\|X|\\|X|        ",
      "||||||||||||||||||)(||||||||||||||||||)(|||||||||||||||||      ",
      "| You hear growling in the darkness  |  Something watches    ",
      "| moves between the gnarled trees... |  you from the dark.   ",
      "~-~-~-~-~-~-~-~ THE  DARK  FOREST ~-~-~-~-~-~-~-~-~-~       ",
    ],
  ...
  bank: {
    lines: [
      ...
      "   | | |   BANK    |  [VAULT]  |  [COINS]  | SAFE  | | |     ",
      "   | | |===========|===========|===========|=======| | |     ",
      "   | | |  |  |  |  |  |  |  | |  |  |  |  |  | |  | | |     ",
      "   |_|_|__|__|__|__|__|__|__|_|__|__|__|__|__|__|__|_|_|_|    ",
      "   [==========[ GRAND  ENTRANCE ]===========================] ",
    ],
    colors: ['yellow','white','white','white','white','white','brown'],
  },
  master: {
    lines: [
      "  *   SETH  ABLE'S  TRAINING  GROUND   *   All Warriors      ",
  ...
  tavern: {
    lines: [
      ...
      " | @  @  @  @    [mug] [mug] [mug]  [#BARREL#]   |           ",
      " |  \\/\\/\\/     -----------------------------------  |  |     ",
      " | /\\  /\\ /\\   | Patrons avoid your eyes here.  |  |  |      ",
      " |/  \\/  \\/  \\ | Smoke hangs heavy. Watch back. |  |  |      ",
      " |[===TABLE====]~[============================]~~|==|==|     ",
    ],
  ...
  news: {
    ...
    colors: ['yellow','white','cyan','gray','white','brown','yellow'],
  },
  character: {
    lines: [
      "  +----------------------------------------------------------+",
      ...
      "  |       Legend of the Red Dragon -- Official               |",
      "  |                                                          |",
      "  +----------------------------------------------------------+",
      "  [==================[ YOUR  LEGEND ]=====================]  ",
    ],
    colors: ['cyan','cyan','yellow','gray','cyan','cyan','yellow'],
  },
};
